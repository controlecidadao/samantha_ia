...
2) Download and unzip the `samantha_ai-main.zip` file (1.6 GB) containing the portable version of the programs (Samantha, DB Browser and Tesseract) by clicking [here](https://tinyurl.com/2urzeb8m). You will need 7 GB of free space after unpacking.
<br><br>
