...
We suggest the model with **Q4_K_M** (4 quantized bits) in its name (put the mouse over the download button to view the file name). As a rule, the larger the model size, the greater the accuracy of the generated texts.
