...
* To keep the generated text always visible on the screen, click inside the _Assistant output_ field and press the Page Down key until you see the end of the text being generated by the model.
<br>
