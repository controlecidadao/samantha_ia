...
🙏 **Special Thanks** to Georgi Gerganov and the whole team working on [llama.cpp](https://github.com/ggerganov/llama.cpp) for making all of this possible, as well to [ableten](https://github.com/abetlen/llama-cpp-python) with the amazing Python bidings for the C++ library.
