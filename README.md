...
✅ **Code Execution Button:** The system allows the user to edit and execute the code generated by the model simply by clicking the “Run Code” button. The output will be displayed in an HTML pop-up window;<br><br>

✅ **"#IDE" feature:** Users can select and run any Python code that uses the libraries installed in the `jupyterlab` virtual environment by entering the characters `#IDE` (even outside of Samantha), copying the code and clicking the "Run Code" button;<br><br>
