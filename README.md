...
* Once installed, open Samantha by double clicking on `open_samantha.bat` file (once again, Windows may [ask](https://i.stack.imgur.com/wa3KQ.png) you to confirm the origin of the .bat file. Click on 'More info' and confirm):<br>
