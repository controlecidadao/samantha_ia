...
* Press `F5` to reload the webpage and reset all fields and settings of the interface. If there was a model loaded via URL, it will be accessible in the _Select model_ dropdown list as `MODEL_FOR_TESTING`.
