...
* Press `F5` to reload the browser tab and press _Clear history_ button to reset all fields and settings of the interface. If there was a model loaded via URL, it will remain loaded and accessible in the _Select model_ dropdown list as `MODEL_FOR_TESTING`.
