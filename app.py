...
language = {
            ...
            'en': {'title': 'Samantha IA - Interface Assistant',
                ...
                'subtitle_3': '<a href="https://www.cos.io/open-science">Open Science</a> project shared on <a href="https://github.com/waltervix/samantha_ia">Github</a> under <a href="https://opensource.org/license/mit"> MIT License</a> (Open Source). Powered by <a href="https://github.com/ggerganov/llama.cpp">Llama.cpp</a> for use with CPU',
                'btn1': 'Start Chat',
                'btn2': 'Stop / Next',
                'btn3': 'Clear History',
                'btn4': 'Load Model',
...
def text_generator(
    ...
    if models == []:
        ...
        model_url = model_url.split('\n')
        model_url = [x.strip() for x in model_url if x[:3] != '---']
        ...
        if 'http' in model_url and previous_model_url != model_url: # True if the models's url (previous_model)url) is replaced by a different model url
            try:
                ...
                print()
                models = download_model(model_url.strip())
