...
llama_cpp_python_version = '0.3.12' # This variable must be updated when llama_cpp_python module is upadated in Samantha
samantha_version = '0.14.0'        # This variable must be updated when Samantha is updated
language = {
            # PORTUGUESE
            'pt': {
                # TITLE ===============================================
