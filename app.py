...
language = {
            ...
            'pt': {'title': 'Samantha Interface Assistant',
                'subtitle_1': 'Ambiente de Interface Experimental Desenvolvido para Democratizar o Uso de Modelos de Inteligência Artificial de Código Aberto (<a href="https://github.com/controlecidadao/samantha_ia">Versão 0.3.0</a>)',
                'warning': 'ATENÇÃO',
            ...
            'en': {'title': 'Samantha Interface Assistant',
                'subtitle_1': 'Experimental Interface Environment Designed to Democratize the Use of Open Source Artificial Intelligence Models (<a href="https://github.com/controlecidadao/samantha_ia">Version 0.3.1</a>)',
                'warning': 'WARNING',
                ...
                'stop_condition_info': "Stop condition (checkbox). Stops Samantha if the Python interpreter prints (in the terminal) a value other than '' (empty string) and that does not contain error message.",
