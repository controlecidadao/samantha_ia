...
# Experimental project developed by MPC-ES team with the aim of encouraging the creation of similar works.
...
# Samantha uses llama.cpp and llama-cpp-python to load and run Large Language Models (LLMs) in UGGF format.
...
# 2) To read aloud the text generated by the models in high quality, use Microsoft Edge browser (Shift + Ctrl + U).
...
# STEPS TO ACTIVATE JUPYTERRLAB VIRTUAL ENVIRONMENT WITH CONDA (e.g. TO CHECK MODULES INSTALLED WITHIN)
...
llama_cpp_python_version = '0.2.90' # This variable must be updated when llama_cpp_python module is upadated in Samantha
...
language = {
            ...
            'pt': {
                ...
                'subtitle_1': 'Interface Experimental Desenvolvida para Testar Modelos de Inteligência Artificial de Código Aberto (<a href="https://github.com/controlecidadao/samantha_ia">Versão 0.5.0</a>)',
                'warning': 'ATENÇÃO',
            ...
            'en': {
                # TITLE ===============================================
                'title': 'Samantha Interface Assistant',
                'subtitle_1': 'Experimental Interface Designed to Test Open Source Artificial Intelligence Models (<a href="https://github.com/controlecidadao/samantha_ia">Version 0.5.0</a>)',
                'warning': 'WARNING',
